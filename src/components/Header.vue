      ...
      <div class="container">
        <div class="ht-left">
          <div class="mail-service">
            <i class=" fa fa-envelope"></i> bookssupply@gmail.com
          </div>
          <div class="phone-service">
            <i class=" fa fa-phone"></i> +62 813 9392 3990
          </div>
        </div>
      </div>
    </div>
                          ...
                          <td class="si-text">
                            <div class="product-selected">
                              <p>
                                Rp
                                {{
                                  (cartUser.price / cartUser.jumlah) | numFormat
                                }}
                                x {{ cartUser.jumlah }}
                              </p>
                              <h6>{{ cartUser.name }}</h6>
...
export default {
  ...
  methods: {
    removeItem(idx) {
      ...
      let cartItemStorage = cartStorage.map(
        (cartItemStorage) => cartItemStorage.id
      );
